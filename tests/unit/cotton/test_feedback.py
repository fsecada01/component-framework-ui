...
def test_notification_cotton_renders_message(cotton_render):
    html = cotton_render(
        "cf/notification.html", message="Done!", type="success", dismissible="true", **{"class": ""}
    )
    assert "Done!" in html
...
def test_notification_cotton_dismissible(cotton_render):
    html = cotton_render(
        "cf/notification.html", message="Hi", type="info", dismissible="true", **{"class": ""}
    )
...
def test_notification_cotton_non_dismissible(cotton_render):
    html = cotton_render(
        "cf/notification.html", message="Hi", type="info", dismissible="false", **{"class": ""}
    )
...
def test_progress_cotton_renders(cotton_render):
    html = cotton_render(
        "cf/progress.html", value="60", max="100", type="info", label="", **{"class": ""}
    )
